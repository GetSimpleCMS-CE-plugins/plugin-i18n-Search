...
$i18n = array(
  ...
  , 'PLACEHOLDER' => "Search words"
		...
		, 'CONFIGURE' => "Søgning"
		, 'CONFIGURATION' => "Søgning"
		, 'VIEW_USAGE' => "Oversigt"
		, 'VIEW_SETTINGS' => "Opsætning"
		, 'INDEX_SETTINGS' => "Indeksering"
		, 'INDEX_DESCRIPTION' => "Indstil vægtning af søgeord på baggrund af findested - Hvis søgeord i titler fx vægtes med værdien \"5\", mens ord i indhold kun vægtes med talværdien \"1\", vil søgeord i titler blive vægtet fem gange højere end søgeord fundet i indhold."
		...
		, 'SEARCHFORM_DESCRIPTION' => "Skal formularen med søgeresultater vise en etiketsky? Slå funktionen fra, hvis der ikke er oprettet etiketter og nøgleord under sideindstillinger."
		, 'SHOW_TAGS' => "Vis etiketsky"
		...
		, 'SAVE_FAILURE' => "De ændrede søgeindstillinger blev ikke gemt."
		, 'SAVE_SUCCESS' => "De ændrede søgeindstillinger blev gemt."
		, 'RESET_FAILURE' => "Søgeindstillinger blev ikke nulstillet."
		, 'RESET_SUCCESS' => "Søgeindstillinger blev sat til standardværdier."
		, 'UNDO_FAILURE' => "Søgeindstillinger blev ikke gendannet."
		, 'UNDO_SUCCESS' => "Søgeindstillinger blev gendannet."
		...
		, 'USAGE_IN_TEMPLATE' => "Anvend kodelinjen herunder for at placere en søgeformular på sidebjælken eller i et sidehoved (hvor \"search\" er ULR'en på den side, hvor søgeresultaterne vises):"
		...
		, 'AJAX_DESCR' => "Værdien \"0\" deaktiverer AJAX-funktionalitet på søgeformular og etiketsky."
